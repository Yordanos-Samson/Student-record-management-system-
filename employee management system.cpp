...
using namespace std;
 ...
 struct employee {
  ...
  void about();//function to show group members
...
int main()
{
    ...
    cout<<"     7 -> to show group members"<<endl;
...
void about(){
            cout<< "||==========================================||" <<endl
                ...
                << "||==========================================||" <<endl
                << "||1.DAGNAW   DERESE-----------------1404358 ||" <<endl
                << "||2.FREZER  TAKELE------------------1404730 ||" << endl
                << "||3.HANA  ABAYNEH ------------------1405274 ||" <<endl
                << "||4.KEFLEMARIAM   MEKONEN ----------1405243 ||" <<endl
                << "||5.MESAFINT GETNET-----------------1404083 ||" << endl
                << "||6.SAMUEL HAILEYESUS --------------1404265 ||" <<endl
                << "||==========================================||" << endl;   }